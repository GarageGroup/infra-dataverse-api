...
{
    [Theory]
    [MemberData(nameof(ApiClientTestDataSource.WhoAmIUnitInputTestData), MemberType = typeof(ApiClientTestDataSource))]
    internal static async Task WhoAmIAsync_Unit_ExpectHttpRequestCalledOnce(
        Guid? callerId, Unit input, DataverseJsonRequest expectedRequest)
    {
    ...
    [Fact]
    public static async Task WhoAmIAsync_Unit_HttpApiThrowsException_ExpectFailure()
    {
    ...
    public static async Task WhoAmIAsync_Unit_ResponseIsFailure_ExpectFailure(
    ...
    [Fact]
    public static async Task WhoAmIAsync_Unit_ResponseIsSuccess_ExpectSuccess()
    {
